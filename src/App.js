...
function App() {
  ...
  const items = [
    ...
    {
      "name": "Cheesecake",
      "description": "A slice of classic New York cheesecake topped with strawberry",
      "price": 3.99,
      "image": "images/sunny.png"
    },
    {
      "name": "Cream Puff",
      "description": "Light and airy pâte à choux filled with sweet whipped cream",
      "price": 2.99,
      "image": "images/tongyu.png"
    }
  ]
  ...
  const listItems = items.map((el) => (
    <div key={el.name}>
      <p>{el.name}</p>
      <img src={el.image} alt="bakery item" width = "100"/>
      <p>{el.description}</p>
      <p>${el.price}</p>
